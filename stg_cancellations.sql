with source as (
  ...
  select * from  {{ source('actblue', 'cancellations') }}
...
renamed as (
  ...
  select
    ...
    recurringtype as recurring_type,

    recurcompleted as num_recur_completed,

    recurpledged as recur_pledged,
    ...
    {{ standardize_timezone('cancelledat') }} as cancelled_at,
